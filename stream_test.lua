...
testing("read_until regex", function()
   local r = re.compile("[ \t\n\r\f\v]")

   local s = stream("\"This is\tnot\ntoo\rgood\",\fhe\vsaid.")
   assert.equals(s:read_until(r, true), "\"This ")
   assert.equals(s:read_until(r, true), "is\t")
   assert.equals(s:read_until(r, true), "not\n")
   assert.equals(s:read_until(r, true), "too\r")
   assert.equals(s:read_until(r, true), "good\",\f")
   assert.equals(s:read_until(r, true), "he\v")
   assert.equals(s:read_until(r, true), "said.")
   assert.equals(s:read_until(r, true), "")

   local s = stream("\"This is\tnot\ntoo\rgood\",\fhe\vsaid.")
   assert.equals(s:read_until(r), "\"This")
   assert.equals(s:read_until(r), "is")
   assert.equals(s:read_until(r), "not")
   assert.equals(s:read_until(r), "too")
   assert.equals(s:read_until(r), "good\",")
   assert.equals(s:read_until(r), "he")
   assert.equals(s:read_until(r), "said.")
