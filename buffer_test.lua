...
testing("buffer", function()
   -- buffer.new() allocates a buffer with default capacity and zero length
   ...
   assert.equals(#buf2, 0) -- initial length is zero
   assert(buf2=="")
   buf2:append("hell")
   assert.equals(buf2.cap, 5)
...
testing("resizing a nil buffer", function()
   local buf = buffer.copy("")
   assert(buf.ptr == nil)
   assert.equals(buf.cap, 0)
   assert.equals(buf.len, 0)
   ...
   buf:resize(100)
   assert(buf.ptr ~= nil)
   assert.equals(buf.cap, 100)
   assert.equals(buf.len, 0)
end)

testing("appending to a nil buffer", function()
   local buf = buffer.copy("")
   assert(buf.ptr == nil)
   assert.equals(buf.cap, 0)
   assert.equals(buf.len, 0)
   ...
   assert(buf.ptr ~= nil)
   assert(buf.cap > 0)
   assert.equals(buf.len, 5)
   assert.equals(buf, "hello")
end)
